...
import com.lennox.util.Compressor;
...
//   private WebElement storeRadioButton;
   ...
   public Map<String,String> getProductDescription(String catalog) throws InterruptedException{
	   ...
	   String productDescription=driver.findElement(By.xpath("//div/text()[normalize-space()='"+catalog+"']/parent::div/preceding-sibling::div/h2[@class='title']")).getText();
	   String yourPrice =wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div/text()[normalize-space()='"+catalog+"']/parent::div/following-sibling::div/div/div[2]/p"))).getText();
	//   String yourPrice=driver.findElement(By.xpath("//div/text()[normalize-space()='"+catalog+"']/parent::div/following-sibling::div/div/div[2]/p")).getText();
	   String listPrice=driver.findElement(By.xpath("//div/text()[normalize-space()='"+catalog+"']/parent::div/following-sibling::div/div/p[2]")).getText().split(":")[1].trim();
	   String model=driver.findElement(By.xpath("//div/text()[normalize-space()='"+catalog+"']/parent::div")).getText();
	  // WebElement shippingRadioButton = wait.until(ExpectedConditions.(By.xpath("//input[@id='shipping-method-"+catalog+"']")));
	    Boolean available =  wait.until(ExpectedConditions.textMatches(By.xpath("//div[@id='ship-to-"+catalog+"']/div[3]"),Pattern.compile("[A-Z a-z0-9]+")));
			   //driver.findElement(By.xpath("//div[@id='ship-to-"+catalog+"']/div[3]")).getText();
	    if(available)
	    {
	   String shippingAvailability= driver.findElement(By.xpath("//div[@id='ship-to-"+catalog+"']/div[3]")).getText();
	   String storeAvailability= driver.findElement(By.xpath("//div[@id='pickup-"+catalog+"']/div[3]")).getText();
	   String zip = driver.findElement(By.xpath("//div[@id='pickup-"+catalog+"']/div[4]/p/span[@class='zip-replace']")).getText();
	   ...
	   String cartStatus=driver.findElement(By.xpath("//button[@id='product-button-"+catalog+"']")).getAttribute("disabled");
	   if(cartStatus==null)
		   cartStatus="Enabled";
	   else cartStatus = "Disabled";
   ...
   public List<WebElement> getProductData(String catalog){
	   List<WebElement> productData=driver.findElements(By.xpath("//div/text()[normalize-space()='"+catalog+"']/parent::div/parent::a/child::div"));
	   return productData;
